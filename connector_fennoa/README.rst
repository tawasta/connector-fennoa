...
Configuration
=============
1. Install this module and make sure the OCA ``queue_job`` framework is available.
...
* Sales invoice payload currently uses a minimal set of fields; more optional
  fields from the Fennoa API may be added in the future.
